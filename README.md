...
SchemeSathi turns a citizen’s financial need into a clear, explainable path: capture a small applicant profile, rank compatible prototype schemes, explain the score, estimate repayment, route to a suitable demo channel partner, and create a trackable application.
...
pnpm --filter @workspace/schemesathi run dev
```
