...
const partnerRows = [
  ...
  { id: "p3", name: "Udyam MFI - Jayanagar", type: "NBFC-MFI", supportedSchemes: ["micro-finance", "working-capital"], serviceArea: "South Bengaluru", address: "4th Block, Jayanagar, Bengaluru", latitude: 12.925, longitude: 77.5938, authorized: true, active: true, fundUtilizationPercent: 68, npaPercent: 7.2, overduePercent: 6.1, processingCapacity: 68, applicationsToday: 14, acceptingApplications: true, serviceQuality: 81, lastUpdated: "2026-09-08T07:45:00.000Z" },
  { id: "p4", name: "People's Development Finance", type: "SCA", supportedSchemes: ["micro-finance", "education-loan"], serviceArea: "North Bengaluru", address: "Yeshwanthpur, Bengaluru", latitude: 13.028, longitude: 77.54, authorized: true, active: false, fundUtilizationPercent: 44, npaPercent: 1.4, overduePercent: 1.2, processingCapacity: 72, applicationsToday: 10, acceptingApplications: false, serviceQuality: 76, lastUpdated: "2026-09-07T16:00:00.000Z" },
  { id: "p5", name: "National Public Bank - Koramangala", type: "PSB", supportedSchemes: ["term-loan", "education-loan", "equipment-support"], serviceArea: "South-East Bengaluru", address: "80 Feet Road, Koramangala, Bengaluru", latitude: 12.9352, longitude: 77.6245, authorized: true, active: true, fundUtilizationPercent: 61, npaPercent: 1.9, overduePercent: 1.5, processingCapacity: 91, applicationsToday: 8, acceptingApplications: true, serviceQuality: 89, lastUpdated: "2026-09-08T09:15:00.000Z" },
];
